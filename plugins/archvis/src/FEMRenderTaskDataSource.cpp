...
megamol::archvis::FEMRenderTaskDataSource::FEMRenderTaskDataSource()
    ...
    , m_version(0) {
    this->m_fem_callerSlot.SetCompatibleCall<CallFEMDataDescription>();
...
bool megamol::archvis::FEMRenderTaskDataSource::getDataCallback(core::Call& caller) {
    ...
    CallFEMData* fem_call = this->m_fem_callerSlot.CallAs<CallFEMData>();
    ...
    rtc->setData(m_gpu_render_tasks,m_version);
